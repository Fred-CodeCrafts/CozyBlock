                ...
                {isOpen && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
                        ...
                        <motion.div
                            ...
                            className="bg-white rounded-3xl p-5 w-full max-w-sm shadow-2xl relative z-10 flex flex-col max-h-[80vh]"
                        >
                            ...
                            <div className="flex flex-col gap-3 max-h-[60vh] overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
                                {STRATEGIES.map((strategy) => (
                                    ...
                                    >
                                        <div className="flex justify-between items-start mb-1">
                                            <h4 className="font-bold text-base">{strategy.name}</h4>
                                            <span className="text-xs font-mono font-bold bg-white/50 px-2 py-1 rounded-md">
                                                {strategy.apy}
                                            </span>
                                        </div>

                                        <p className="text-xs opacity-80 mb-3">{strategy.description}</p>
